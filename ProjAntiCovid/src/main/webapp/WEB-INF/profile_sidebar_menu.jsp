...
<div class="sidebar-menu round-borders">
    ...
    <div class="sidebar-menu-item">
        ...
        <div class="sidebar-menu-body accordion-content-linked accordion-open">
            <!-- SIDEBAR MENU LINK -->
            <a class="sidebar-menu-link" href="profile">Profile Info</a>
            <!-- /SIDEBAR MENU LINK -->

            <!-- SIDEBAR MENU LINK -->
            <a class="sidebar-menu-link" href="notifications">Notifications</a>
            <!-- /SIDEBAR MENU LINK -->

            <!-- SIDEBAR MENU LINK -->
            <a class="sidebar-menu-link" href="friends">Friend Requests</a>
            <!-- /SIDEBAR MENU LINK -->
        </div>
        <!-- /SIDEBAR MENU BODY -->
    </div>
