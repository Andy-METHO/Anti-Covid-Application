...
<body>
				     	...
				     	<tr>
				            ...
				            <td>
	      				 		<form action="friends" method="POST">
								    <button name="delatefriend" value="${friendslist.getFriends(i).getPseudo()}">Retirer</button>
								</form>
							</td>
				        </tr>
				      	</c:forEach>			      	
	      		...
	      		<table>
	      			<tr>
				     	...
				     	<tr>
				            ...
				            <td>
	      				 		<form action="friends" method="POST">
								    <button name="delateRequest_received" value="${friendslist.getRequest_received(i).getPseudo()}">NON</button>
								</form>
							</td>
				        </tr>
				      	</c:forEach>			      	
  ...
  <div class="section-header">
    <div class="section-header-info">
        <!-- SECTION TITLE -->
        <h2 class="section-title">Requêtes envoyées</h2>
        <!-- /SECTION TITLE -->
      </div>
    </div>
    <div class="calendar-widget">
	      		...
	      		<table>
	      			<tr>
				     	...
				     	<tr>
				            ...
				            <td>
	      				 		<form action="friends" method="POST">
								    <button name="delateRequest_send" value="${friendslist.getRequest_send(i).getPseudo()}">Retirer</button>
								</form>
							</td>
				        </tr>
				      	</c:forEach>			      	
